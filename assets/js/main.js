    ...
    var imJs = {
        ...
        activePopupDemo: function (e) {
            $('.popuptab-area li a.demo-dark').on('click', function (e) {
                $('.template-color-1').addClass('dark-version');
                $('.template-color-1').removeClass('white-version');
            });

            $('.popuptab-area li a.demo-light').on('click', function (e) {
                $('.template-color-1').removeClass('dark-version');
                $('.template-color-1').addClass('white-version');
            })
        },

        demoActive: function (e) {
            $('.rn-right-demo').on('click', function (e) {
                $('.template-color-1').addClass('open');
            })
            $('.demo-close-btn').on('click', function (e) {
                $('.template-color-1').removeClass('open');
            })
        },
        ...
        vedioActivation: function (e) {
            $('#play-video').on('click', function (e) {
                ...
                $("#video-overlay").append('<iframe width="80%" height="80%" src="https://www.youtube.com/embed/" frameborder="0" allowfullscreen></iframe>');
            });
